...
const board_page_1 = __webpack_require__(/*! ./page/board.page */ "./src/page/board.page.tsx");
const home_page_1 = __webpack_require__(/*! ./page/home.page */ "./src/page/home.page.tsx");
const post_page_1 = __webpack_require__(/*! ./page/post.page */ "./src/page/post.page.tsx");
const write_post_page_1 = __webpack_require__(/*! ./page/write-post.page */ "./src/page/write-post.page.tsx");
const routes_1 = __webpack_require__(/*! ./routes */ "./src/routes.ts");
const user_action_1 = __webpack_require__(/*! ./action/user.action */ "./src/action/user.action.ts");
const user_request_1 = __webpack_require__(/*! ./lib/user.request */ "./src/lib/user.request.ts");
...
class App extends React.Component {
    componentWillReceiveProps() {
        user_request_1.UserAPIRequest.checkSignedIn()
            .then((res) => {
            const body = res.data;
            if (body["state"]["signed"]) {
                index_1.store.dispatch(user_action_1.UserActionCreator.setUser(object_factory_1.ObjectFactory.createUserObject(body["state"]["user"])));
            }
            else {
                index_1.store.dispatch(user_action_1.UserActionCreator.setUser(undefined));
            }
        });
    }
    render() {
        return (React.createElement(react_redux_1.Provider, { store: index_1.store },
            React.createElement(Router.BrowserRouter, null,
                React.createElement("div", { className: "router-wrapper" },
                    React.createElement(Router.Route, { exact: true, path: routes_1.Routes.routeRoot, component: home_page_1.default }),
                    React.createElement(Router.Route, { path: routes_1.Routes.routeBoard, component: board_page_1.default }),
                    React.createElement(Router.Route, { path: routes_1.Routes.routeWrite, component: write_post_page_1.default }),
                    React.createElement(Router.Route, { path: routes_1.Routes.routePost, component: post_page_1.default })))));
    }
}
exports.App = App;
...
/***/ "./src/action/navigation.action.ts":
/*!*****************************************!*\
  !*** ./src/action/navigation.action.ts ***!
  \*****************************************/
/*! no static exports found */
...
(function (NavigationActionType) {
    NavigationActionType["SET_BOARD_TITLE"] = "SET_BOARD_TITLE";
    NavigationActionType["SET_PAGE_NUM"] = "SET_PAGE_NUM";
    NavigationActionType["SET_POST"] = "SET_POST";
})(NavigationActionType = exports.NavigationActionType || (exports.NavigationActionType = {}));
class NavigationActionCreator {
    static setBoardTitle(boardTitle) {
        return {
            type: NavigationActionType.SET_BOARD_TITLE,
            title: boardTitle,
        };
    }
    static setPageNum(numPage) {
        return {
...
exports.NavigationActionCreator = NavigationActionCreator;
...
(function (UserActionType) {
    UserActionType["SET_USER"] = "SET_USER";
    UserActionType["INVALIDATE_USER"] = "INVALIDATE_USER";
...
class Button extends React.Component {
    render() {
        return (React.createElement("button", { className: "btn bg-primary text-white text-center" },
            React.createElement("img", { src: this.props.iconSrc, alt: "button", className: "icon mr-2", onClick: this.props.onClick }),
            this.props.text));
    }
}
...
/***/ "./src/component/login-form.component.tsx":
/*!************************************************!*\
  !*** ./src/component/login-form.component.tsx ***!
  \************************************************/
/*! no static exports found */
            ...
            React.createElement("div", { className: "row" },
                React.createElement("form", { className: "col" },
                    React.createElement("div", { className: "form-group" },
                        React.createElement("label", { htmlFor: "username" }, "ID"),
                        React.createElement("input", { id: "username", type: "text", className: "form-control", placeholder: "\uD559\uBC88", "aria-label": "Username", onKeyUp: this.onKeyUp })),
                    React.createElement("div", { className: "form-group" },
                        React.createElement("label", { htmlFor: "password" }, "PW"),
                        React.createElement("input", { id: "password", type: "password", className: "form-control", placeholder: "Password", "aria-label": "Password", onKeyUp: this.onKeyUp }))),
...
/***/ "./src/component/paginator.component.tsx":
/*!***********************************************!*\
  !*** ./src/component/paginator.component.tsx ***!
  \***********************************************/
/*! no static exports found */
 ...
 */
const React = __webpack_require__(/*! react */ "react");
class BoardPaginator extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const toPrev = this.min > this.props.pageMin ?
            (React.createElement("a", { onClick: () => { this.props.onPreviousClick(this.props.pageCurrent, this.min); } }, "\u226A \uC774\uC804 \uD398\uC774\uC9C0")) : undefined;
        const toNext = this.max < this.props.pageMax ?
            (React.createElement("a", { onClick: () => { this.props.onNextClick(this.props.pageCurrent, this.max); } }, "\uB2E4\uC74C \uD398\uC774\uC9C0 \u226B")) : undefined;
        return (React.createElement("div", null,
            toPrev,
            this.arr.map((num, idx) => {
                return React.createElement("a", { className: "mx-3", onClick: () => this.props.onPageClick(num) }, num);
            }),
            toNext));
    }
}
exports.BoardPaginator = BoardPaginator;


/***/ }),

/***/ "./src/component/post-list-item.component.tsx":
/*!****************************************************!*\
  !*** ./src/component/post-list-item.component.tsx ***!
  \****************************************************/
/*! no static exports found */
...
class PostListItem extends React.Component {
    render() {
        return (React.createElement("li", { className: "list-group-item", onClick: () => this.props.onClick(this.props.post.getId()) },
            React.createElement(react_router_dom_1.Link, { to: `/post?id=${this.props.post.getId()}` }, this.props.post.getTitle())));
    }
}
...
/***/ "./src/component/post-list.component.tsx":
/*!***********************************************!*\
  !*** ./src/component/post-list.component.tsx ***!
  \***********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const post_list_item_component_1 = __webpack_require__(/*! ./post-list-item.component */ "./src/component/post-list-item.component.tsx");
class PostList extends React.Component {
    render() {
        return (React.createElement("ul", { className: "list-group" }, this.props.posts.map((obj, i) => React.createElement(post_list_item_component_1.PostListItem, { key: obj.getId(), post: obj, onClick: this.props.onItemClick }, obj.getTitle()))));
    }
}
...
/***/ "./src/component/side-menu.component.tsx":
/*!***********************************************!*\
  !*** ./src/component/side-menu.component.tsx ***!
  \***********************************************/
/*! no static exports found */
...
class SideMenu extends React.Component {
    render() {
        return (React.createElement("ul", { className: "list-group" }, this.props.items.map((item, index) => {
            return (React.createElement("li", { key: index, className: "list-group-item", onClick: () => { this.props.onItemClick(item); } }, item.name));
        })));
    }
}
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
const file_obj_1 = __webpack_require__(/*! ./file.obj */ "./src/lib/file.obj.ts");
const post_obj_1 = __webpack_require__(/*! ./post.obj */ "./src/lib/post.obj.ts");
const reply_obj_1 = __webpack_require__(/*! ./reply.obj */ "./src/lib/reply.obj.ts");
...
class ObjectFactory {
    ...
    static createUserObject(obj) {
        const user = new user_obj_1.UserObject(obj["sid"], obj["name"], obj["role"], obj["id"]);
        return user;
    }
    static createReplyObject(obj) {
        const reply = new reply_obj_1.ReplyObject(obj["reply_content"], this.createUserObject(obj["author"]), new Date(obj["date_created"]), obj["id"]);
        return reply;
    }
    static createPostObject(obj) {
        ...
        const post = new post_obj_1.PostObject(obj["post_title"], obj["board"], obj["id"], obj["post_content"], files, obj["date_created"], this.createUserObject(obj["author"]));
        return post;
    }
}
...
var BoardTitle;
(function (BoardTitle) {
    BoardTitle["seminar"] = "\uC138\uBBF8\uB098";
    BoardTitle["works"] = "\uACFC\uC81C";
    BoardTitle["jrBoard"] = "\uC2E0\uC785\uC0DD \uC790\uB8CC\uC2E4";
})(BoardTitle = exports.BoardTitle || (exports.BoardTitle = {}));
class PostObject {
    constructor(title, board, id, content, filesAttached, dateCreated, author, replies) {
        this.title = title;
        this.board = board;
        this.id = id;
    ...
    getFilesAttached() { return this.filesAttached; }
...
PostAPIRequest.createPost = (title, content, boardTitle, fileIds) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/post/write`, {
        method: "POST",
        data: {
            post_title: title,
...
PostAPIRequest.retrievePostList = (page, year, boardTitle) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/post/page/${page}`, {
        method: "GET",
        headers: {
...
PostAPIRequest.retrievePostById = (postId) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/post/${postId}`, {
        method: "GET",
        withCredentials: true,
    });
};
...
PostAPIRequest.deletePost = (postId) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/post/delete/${postId}`, {
        method: "DELETE",
        withCredentials: true,
    });
};
...
Object.defineProperty(exports, "__esModule", { value: true });
class ReplyObject {
    constructor(content, author, dateCreated, id) {
        this.content = content;
        this.author = author;
        this.dateCreated = dateCreated;
        this.id = id;
...
exports.ReplyObject = ReplyObject;
...
UserAPIRequest.registerUser = (user, pw) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/user/register`, {
        method: "POST",
        data: {
            name: user.getName(),
            sid: user.getSid(),
...
UserAPIRequest.loginUser = (id, pw) => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/auth/login`, {
        method: "POST",
        data: {
            id,
            pw,
...
UserAPIRequest.logoutUser = () => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/auth/logout`, {
        method: "GET",
        withCredentials: true,
    });
};
UserAPIRequest.checkSignedIn = () => {
    return axios_1.default(`${config_1.config.baseurl}/api/v1/auth/check`, {
        method: "GET",
        withCredentials: true,
    });
};
...
const post_obj_1 = __webpack_require__(/*! ../lib/post.obj */ "./src/lib/post.obj.ts");
const object_factory_1 = __webpack_require__(/*! ../lib/object-factory */ "./src/lib/object-factory.ts");
const component_ready_1 = __webpack_require__(/*! ../lib/component-ready */ "./src/lib/component-ready.ts");
const button_component_1 = __webpack_require__(/*! ../component/button.component */ "./src/component/button.component.tsx");
const paginator_component_1 = __webpack_require__(/*! ../component/paginator.component */ "./src/component/paginator.component.tsx");
const post_list_component_1 = __webpack_require__(/*! ../component/post-list.component */ "./src/component/post-list.component.tsx");
const side_menu_component_1 = __webpack_require__(/*! ../component/side-menu.component */ "./src/component/side-menu.component.tsx");
const navigation_action_1 = __webpack_require__(/*! ../action/navigation.action */ "./src/action/navigation.action.ts");
const user_action_1 = __webpack_require__(/*! ../action/user.action */ "./src/action/user.action.ts");
class BoardPage extends React.Component {
    constructor(props) {
        ...
        this.update = (title, page) => {
            let matchedTitle;
            for (const t in post_obj_1.BoardTitle) {
                if (title === post_obj_1.BoardTitle[t]) {
                    matchedTitle = post_obj_1.BoardTitle[t];
                    break;
                }
            }
            if (!matchedTitle) {
                title = post_obj_1.BoardTitle.seminar;
            }
            this.setState({ title: title, page }, () => {
                reqPost.PostAPIRequest.retrievePostList(this.state.page, new Date().getFullYear(), this.state.title)
                    .then((res) => {
                    if (res.status === 200) {
                        const body = res.data;
                        const posts = [];
                        for (const p of body["posts"]["posts"]) {
                            posts.push(object_factory_1.ObjectFactory.createPostObject(p));
                        }
                        this.setState({ posts, pageMax: body["posts"]["total"] });
        ...
        for (const t in post_obj_1.BoardTitle) {
            this.state.menuItems.push({
                name: post_obj_1.BoardTitle[t],
                linkTo: `/board?title=${post_obj_1.BoardTitle[t]}&page=1`,
            });
        }
    }
    componentDidMount() {
        component_ready_1.onComponentReady();
        const queries = query.parse(location.search);
        this.setState({
            title: queries["title"] || post_obj_1.BoardTitle.seminar,
            page: queries["page"] || 1
        });
        if (!this.props.user) {
    ...
    render() {
        return (React.createElement("div", null,
            ...
            React.createElement(side_menu_component_1.SideMenu, { items: this.state.menuItems, onItemClick: (item) => { this.update(item.name, 1); } }),
            React.createElement("h1", { className: "board-title" }, this.state.title),
            React.createElement(post_list_component_1.PostList, { posts: this.state.posts, onItemClick: this.onPostClick }),
            React.createElement(ReactRouter.Link, { to: "/" }, "Home"),
            React.createElement(ReactRouter.Link, { to: "/write" },
                React.createElement(button_component_1.Button, { text: "\uAE00\uC4F0\uAE30", iconSrc: "/img/ic_create_white_48px.svg" })),
            React.createElement("button", { className: "btn", onClick: this.onLogout }, "logout"),
            React.createElement(paginator_component_1.BoardPaginator, { pageMin: 1, pageMax: this.state.pageMax, pageCurrent: this.state.page, pagePlusMinus: 3, onPageClick: (page) => { this.update(this.state.title, page); }, onNextClick: (currnet, max) => {
                    this.update(this.state.title, max + 1);
                }, onPreviousClick: (current, min) => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        onSessionVerified: (user) => {
            dispatch(user_action_1.UserActionCreator.setUser(user));
        },
        onBoardLoaded: (title, page) => {
            dispatch(navigation_action_1.NavigationActionCreator.setBoardTitle(title));
            dispatch(navigation_action_1.NavigationActionCreator.setPageNum(page));
        },
    };
};
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const component_ready_1 = __webpack_require__(/*! ../lib/component-ready */ "./src/lib/component-ready.ts");
const login_form_component_1 = __webpack_require__(/*! ../component/login-form.component */ "./src/component/login-form.component.tsx");
const object_factory_1 = __webpack_require__(/*! ../lib/object-factory */ "./src/lib/object-factory.ts");
const user_request_1 = __webpack_require__(/*! ../lib/user.request */ "./src/lib/user.request.ts");
const user_action_1 = __webpack_require__(/*! ../action/user.action */ "./src/action/user.action.ts");
    ...
    componentDidMount() {
        ...
        if (this.props.user) {
            ...
            user_request_1.UserAPIRequest.checkSignedIn()
                ...
                const body = res.data;
                if (body["state"]["signed"]) {
                    this.props.onSessionVerified(object_factory_1.ObjectFactory.createUserObject(body["state"]["user"]));
                    alert("이미 로그인되어있습니다.");
                    this.props.history["push"]("/board");
                }
            });
    ...
    render() {
        return (React.createElement("div", { className: "home-wrapper d-flex flex-column justify-content-center" },
            ...
            React.createElement("div", { className: "home-login-box mx-auto mt-5 px-4 py-3" },
                React.createElement(login_form_component_1.LoginForm, { history: this.props.history, onLoginButtonClick: this.onLoginButtonClick }))));
    }
}
const mapStateToProps = (state) => {
    return {
...
exports.default = react_redux_1.connect(null, mapDispatchToProps)(HomePage);


/***/ }),

/***/ "./src/page/post.page.tsx":
/*!********************************!*\
  !*** ./src/page/post.page.tsx ***!
  \********************************/
/*! no static exports found */
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const react_router_dom_1 = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
const post_request_1 = __webpack_require__(/*! ../lib/post.request */ "./src/lib/post.request.ts");
const component_ready_1 = __webpack_require__(/*! ../lib/component-ready */ "./src/lib/component-ready.ts");
const object_factory_1 = __webpack_require__(/*! ../lib/object-factory */ "./src/lib/object-factory.ts");
class PostPage extends React.Component {
    ...
    componentDidMount() {
        ...
        const queries = query.parse(location.search);
        const id = queries["id"];
        post_request_1.PostAPIRequest.retrievePostById(id)
            .then((res) => {
            if (res.status >= 400) {
                alert("Error occurred while load post");
            }
            else {
                this.setState({ post: object_factory_1.ObjectFactory.createPostObject(res.data["post"]) });
            }
        });
    }
    render() {
        return (React.createElement("div", null,
            React.createElement("h1", null, this.state.post ? this.state.post.getTitle() : ""),
            React.createElement("p", null, this.state.post ? this.state.post.getContent() : ""),
            React.createElement(react_router_dom_1.Link, { to: `/write?mod=true&id=` },
                React.createElement("h5", null, "\uC218\uC815")),
            React.createElement("h5", null, "\uC0AD\uC81C"),
            React.createElement(react_router_dom_1.Link, { to: `/board?title=${this.props.boardTitleFrom}&page=${this.props.pageNumFrom}` },
                React.createElement("h5", null, "\u226A \uBAA9\uB85D\uC73C\uB85C"))));
    }
}
const mapStateToProps = (state) => {
    return {
...
exports.default = react_redux_1.connect(mapStateToProps, null)(PostPage);


/***/ }),

/***/ "./src/page/write-post.page.tsx":
/*!**************************************!*\
  !*** ./src/page/write-post.page.tsx ***!
  \**************************************/
/*! no static exports found */
...
class WritePostPage extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            "Write some post",
            React.createElement("div", { className: "form-group" },
                React.createElement("label", { htmlFor: "title" }, "\uC81C\uBAA9"),
            ...
            React.createElement("div", { className: "form-group" },
                ...
                React.createElement("textarea", { id: "content", className: "form-control", ref: "contentForm", rows: 20 })),
            React.createElement("span", { className: "float-right", onClick: () => this.onWriteClicked() },
                React.createElement(button_component_1.Button, { text: "\uC644\uB8CC", iconSrc: "/img/ic_create_white_48px.svg" }))));
    }
}
const mapStateToProps = (state) => {
    return {
...
exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(WritePostPage);
...
Object.defineProperty(exports, "__esModule", { value: true });
const post_obj_1 = __webpack_require__(/*! ../lib/post.obj */ "./src/lib/post.obj.ts");
const navigation_1 = __webpack_require__(/*! ./navigation */ "./src/reducer/navigation.ts");
const user_1 = __webpack_require__(/*! ./user */ "./src/reducer/user.ts");
const navigation_action_1 = __webpack_require__(/*! ../action/navigation.action */ "./src/action/navigation.action.ts");
const user_action_1 = __webpack_require__(/*! ../action/user.action */ "./src/action/user.action.ts");
const initialState = {
    user: undefined,
    current: {
        boardTitle: post_obj_1.BoardTitle.seminar,
        page: 1,
        post: undefined,
    },
};
exports.reduce = (state = initialState, action) => {
    if (action.type in user_action_1.UserActionType) {
        return user_1.userReducer(state, action);
    }
    else if (action.type in navigation_action_1.NavigationActionType) {
        return navigation_1.navigationReducer(state, action);
    }
    else {
        return state;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
const navAction = __webpack_require__(/*! ../action/navigation.action */ "./src/action/navigation.action.ts");
exports.navigationReducer = (state, action) => {
    const newState = Object.assign({}, state);
    switch (action.type) {
        case navAction.NavigationActionType.SET_BOARD_TITLE:
            newState.current.boardTitle = action.title;
            return newState;
        case navAction.NavigationActionType.SET_PAGE_NUM:
            newState.current.page = action.numPage;
            return newState;
        case navAction.NavigationActionType.SET_POST:
            newState.current.post = action.post;
            return newState;
        default:
            return state;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
const user_action_1 = __webpack_require__(/*! ../action/user.action */ "./src/action/user.action.ts");
exports.userReducer = (state, action) => {
    const newState = Object.assign({}, state);
    switch (action.type) {
        case user_action_1.UserActionType.SET_USER:
            newState.user = action.user;
            return newState;
        case user_action_1.UserActionType.INVALIDATE_USER:
...
Routes.routeRoot = `/`;
Routes.routeBoard = `/board`;
Routes.routeWrite = `/write`;
Routes.routePost = `/post`;
...
const reducer_1 = __webpack_require__(/*! ../reducer */ "./src/reducer/index.ts");
exports.store = redux.createStore(reducer_1.reduce);
