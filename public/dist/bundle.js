...
class PostListItem extends React.Component {
    render() {
        return (React.createElement("li", { key: this.props.post.getId(), className: "list-group-item", onClick: () => this.props.onClick(this.props.post.getId()) }, this.props.post.getTitle()));
    }
}
...
class PostList extends React.Component {
    render() {
        return (React.createElement("ul", { className: "list-group" }, this.props.posts.map((obj, i) => React.createElement(post_list_item_component_1.PostListItem, { post: obj, onClick: this.props.onItemClick }, obj.getTitle()))));
    }
}
...
class ObjectFactory {
    ...
    static createPostObject(obj) {
        ...
        const post = new post_obj_1.PostObject(obj["post_title"], obj["board"], obj["_id"], obj["post_content"], files, obj["date_created"], this.createUserObject(obj["author"]));
        return post;
    }
}
